...
(function (lwc) {
    ...
    tmpl.stylesheetTokens = {
      hostAttribute: "c-greetUser_greetUser-host",
      shadowAttribute: "c-greetUser_greetUser"
    };

    class GreetUser extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
    ...
    lwc.registerDecorators(GreetUser, {
      track: {
        message: 1
      }
    });

    var main = lwc.registerComponent(GreetUser, {
      tmpl: _tmpl
    });

    registerWireService(lwc.register);

        const element = lwc.createElement('c-greetUser', { is: main, fallback: true });
